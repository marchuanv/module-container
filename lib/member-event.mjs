...
export class MemberEvent extends Reference {
    ...
    */
    constructor(memberInfoRefId, memberEventStackRefId, containerRefId, memberEventCallStackRefId, raisedEventLoggingRefId) {
        super(`${memberInfoRefId.name}_event`);
        this.dependency = memberInfoRefId;
        this.dependency = memberEventStackRefId;
