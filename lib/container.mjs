...
export class Container {
   constructor() {
      ...
      createPrivateFunction({
         name: 'promise', instance: this, callback: (func) => {
            promises.delete(thisRef);
            return promises.set(thisRef, func);
         }
      });
      bag.delete(thisRef);
      bag.set(thisRef, {});
   ...
   addDependency({ ref, Class, args = {} }) {
      ...
      createPrivateProperty({
         name: ref, instance: this, callback: async () => {
...
const createPrivateProperty = function ({ name, instance, callback }) {
   Object.defineProperty(instance, name, {
      configurable: false, get: async function () {
...
const createPrivateFunction = function ({ name, instance, callback }) {
   Object.defineProperty(instance, name, {
      configurable: false, value: async function () {
         const caller = (new Error()).stack.split("\n")[2].trim().split(" ")[1];
         const callerSeg = caller.split('.');
         const callingFuncName = callerSeg[callerSeg.length - 1];
         const actualClassName = instance.constructor.name;
