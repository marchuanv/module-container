         ...
         if (isSingleton) {
            ...
            if (singletons.has(contextName)) {
               ...
               if (singletonContext.contextId !== this.contextId) {
                  interfaceMember.call(this, singletonContext);
                  Object.freeze(this);
                  return;
               }
            }
      ...
      while (node.nextChild) {
         ...
         if (type && args) {
            ...
            if (mockType && !process.environment.isProduction) {
               memberInfo = new MemberInfo(key, mockType, args, false, null, false, false, true, false, this.contextId);
            } else {
...
const interfaceMember = function (context) {
   for (const memberInfo of getMembersInfo.call(this, context)) {
      memberInfo.setAsInterface();
      Member.createMember({ memberInfo, context: this });
   }
}
