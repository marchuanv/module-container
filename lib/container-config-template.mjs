...
export class ContainerConfigTemplate extends ContainerConfigNode {
    constructor() {
        ...
        const properties = new ContainerConfigNode();
        properties.build('properties', [refProperty, refProperty2, staticProperty]);
        ...
        _class.build('class', [_name2, args4, ctor, errorHalt, isInterface, isSingleton, isPublic5, properties, methods]);
