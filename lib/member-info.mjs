...
export class MemberInfo extends Reference {
    ...
    */
   constructor(name, functions, args, isPublic, value, isFunction, isProperty, isCtorExtension, isSingleton, isClass, containerRefId) {
      super(name);
      if (containerRefId) {
      ...
      this.data.isCtorExtension = isCtorExtension;
   ...
   get isCtorExtension() {
      const { isCtorExtension } = this.data;
      return isCtorExtension;
   }
   get isFunction() {
