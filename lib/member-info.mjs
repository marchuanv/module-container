...
const configureProperties = function (name, func, args, isPublic, value, isInterface, isProperty, isFunction, isCallBeforePublicMember, contextId) {
   ...
   properties.isInterface = isInterface;
   return properties;
}
...
export class MemberInfo {
   properties;
   constructor(name, func, args, isPublic, value, isInterface, isFunction, isProperty, isCallBeforePublicMember, contextId) {
      children.set(this, []);
      parent.set(this, null);
      this.properties = configureProperties.call(this, name, func, args, isPublic, value, isInterface, isProperty, isFunction, isCallBeforePublicMember, contextId);
   }
   setAsInterface() {
      this.properties = configureProperties.call(this, this.name, this.func, this.args, this.isPublic, this.value, true, this.isProperty, this.isFunction, this.isCallBeforePublicMember, this.contextId);
   }
   get contextId() {
      return this.properties["contextId"];
   }
   get children() {
