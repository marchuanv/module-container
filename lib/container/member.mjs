...
const propertyMemberCallback = function ({ memberInfo, data, logging }) {
   return new Promise((resolve, reject) => {
         ...
         for (const Class of memberInfo.func) {
            if (typeof Class === 'function') {
               try {
                  ...
                  logging.log(`instance of ${instance.constructor.name} was created in ${this.contextId} context.`);
               } catch (error) {
...
const publicMemberEventCallback = function ({ memberInfo, data, logging }) {
   return new Promise(async (resolve, reject) => {
      try {
...
const privateMemberEventCallback = async function ({ memberInfo, data, logging }) {
   return new Promise(async (resolve, reject) => {
