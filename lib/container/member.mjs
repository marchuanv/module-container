      ...
      if (memberInfo.isClass || memberInfo.isContainerClass || memberInfo.isValueType) {
         ...
         const raisePrivatePropertyGetterSetterEvent = (data) => {
            return new Promise( async (resolve, reject) => {
               await MemberEvent.getEvent({ memberInfo }).raise({ data, resolve, reject, timeoutMill: 3 });
            });
         }
         ...
         const raisePublicAsyncFuncMemberEvent = (data) => {
            return new Promise( async (resolve, reject) => {
               await MemberEvent.getEvent({ memberInfo }).raise({ data, resolve, reject, timeoutMill: 1 });
            });
         }
         ...
         const raisePrivateAsyncFuncMemberEvent = (data) => {
            return new Promise( async (resolve, reject) => {
               await MemberEvent.getEvent({ memberInfo }).raise({ data, resolve, reject, timeoutMill: 2 });
            });
         }
