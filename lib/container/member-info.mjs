...
export class MemberInfo {
   constructor(name, func, args, isPublic, value, isCtorDependency = false) {
      const properties = {};
      ...
      properties.isCtorDependency = isCtorDependency;
   ...
   get isCtorDependency() {
      return memberInfoProperties.get(this)["isCtorDependency"];
   }
   get enabled() {
