...
const configureProperties = function(name, func, args, isPublic, value, isProxy) {
...
export class MemberInfo {
   ...
   constructor(name, func, args, isPublic, value) {
      this.properties = configureProperties.call(this, name, func, args, isPublic, value, false);
   }
   proxy() {
      this.properties = configureProperties.call(this, this.name, this.func, this.args, this.isPublic, this.value, true);
   }
   get isProxy() {
