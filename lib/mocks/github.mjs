            ...
            members: {
                ...
                setup: {
                    ...
                    callback:  async () => {
                        ...
                        octokit.files.set('joe.json', 'eyAic3RvcmVkSGFzaGVkUGFzc3BocmFzZSI6IG51bGwsICJzdG9yZWRIYXNoZWRQYXNzcGhyYXNlU2FsdCI6IG51bGwsICJzdG9yZWREZWNyeXB0aW9uS2V5IjogbnVsbCB9');
                    }
                },
            },
            behaviour: {
