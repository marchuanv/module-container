    ...
    shift() {
        ...
        if (memberEvent) {
            ...
            if (memberInfo.isPublic) {
                ...
                if (prevMemberEvent) {
                    let { prevClassMember } = getMembersInfo.call(this, prevMemberEvent);
                    while (prevMemberEvent) {
                        if (prevMemberInfo.isPublic && classMemberInfo.Id === prevClassMember.Id) {
                            isPrivate = false;
                            break;
                        }
                        prevMemberEvent = super.shiftStack(MemberEvent.prototype);
                        ({ prevClassMember } = getMembersInfo.call(this, prevMemberEvent));
                    }
                }
            }
