...
export class Member extends Reference {
    ...
    * @param { ReferenceId } memberEventSubsriptionRefId
    * @param { ReferenceId } memberEventPublisherRefId
    */
   constructor(containerRefId, memberInfoRefId, memberEventSubsriptionRefId, memberEventPublisherRefId) {
      super(`${memberInfoRefId.name}_member`);
      this.dependency = containerRefId;
      this.dependency = memberInfoRefId;
      this.dependency = memberEventSubsriptionRefId;
