...
export class Member extends MemberReference {
   ...
   async create() {
      ...
      const memberEventSubscriber = super.memberEventSubscriber;
      const memberEventPublisher = super.memberEventPublisher;
      if (!container.interface) {
         if (memberInfo.isProperty) {
            memberEventSubscriber.subscribe(() => {
         ...
         if (memberInfo.isFunction) {
            memberEventSubscriber.subscribe(async () => {
